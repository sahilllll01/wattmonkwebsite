...
import CommecrialPermitPackageImgs from "../json-data/CommecrialPermitPackageImgs";
import CommecrialPermitPackageItems from "../json-data/CommecrialPermitPackageItems";
    ...
    <div className="services container-fluid px-0">
      ...
      <section className="section--01">
        ...
        <div className="section-content-container container d-flex">
          ...
          >
            <h1 className="element-heading big-h">PV Permit Plan Commercial</h1>
            <p>
          ...
          >
            <img src="/commercial-permit-design.png" alt="" />
        ...
        <div className="container">
          ...
          <Tabs className="tabs-section d-flex bg-white simple-shadow ">
            <div className="tabs-section__r bg-black col-12 col-lg-4">
              <TabList>
                {CommecrialPermitPackageItems.map((val) => {
                  const { title, id } = val;
            ...
            <div className="tabs-section__l col-12 col-lg-8 d-flex">
              {CommecrialPermitPackageImgs.map((val) => {
                const { id, img } = val;
                return (
                  <TabPanel key={id}>
